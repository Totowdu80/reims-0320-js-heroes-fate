...
function Instruction() {
  return (
    <div>
      <h1> Bienvenue dans Heroes Fate,</h1>
      <p>
      ...
      <p>
        Pour la phases d'attaque vous avez le choix entre trois type attaque différente,(nom des attaques) qui font plus ou moins de dégâts de la plus forte a la moins forte
      ...
      <p>
        Pour la phases de défense même principe, vous avez le choix entre trois type de défense différente,(nom des defenses) qui permette soit d'esquiver complètement l'attaque, sois d'affaiblir les dommage de celle ci
