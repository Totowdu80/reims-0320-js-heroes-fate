      ...
      <div className="rulescontainer">
        ...
        <div className="ParInstruc">
          ...
          <div className="rulesintracontainer">
            ...
            <p>
              Au centre de votre écran se trouve le plateau de jeu, dans lequel toutes les actions principales vont se dérouler et dans lequel vont s'enchainer des tours endiablés de combats
              entre votre héros et son ennemi.
            </p>
            <p>
              Enfin, au bas de votre écran se trouve, la partie d'interface de votre héros qui, tout comme votre ennemi, présentera son nom, son avatar, sa vie ainsi que ses statistiques.
            </p>
          </div>
        ...
        <div className="ParInstruc">
          ...
          <div className="rulesintracontainer">
            ...
            <p>
              La statistique d'initiative déterminera qui du joueur ou de l'ennemi attaquera le premier : celui avec la statistique la plus haute sera le premier à attaquer
            </p>
            <div className="instrucPart1">
              ...
              <div className="parAttak">
                <p>
                  Une fois cela déterminé, le combat peut commencer, le premier joueur entre alors en phase d'attaque et accède ainsi à une interface lui proposant 3 attaques : petite attaque,
                  attaque moyenne et puissante attaque, chacune ayant leurs propres caratéristiques. Plus une attaque fera de dégâts, moins elle aura de chance de réussir.
                </p>
                <p>
                  ...
                  3 choix différents tout comme l'attaque avec également un taux de réussite qui dépend des dégâts bloqués. Tout comme l'attaque, une fois le choix fait, un dé est alors lancé afin de définir
                  si oui ou non la défense est réussie.
                </p>
              </div>
            </div>
        ...
        <div className="buttonPlayInstruc">
          <div>
            <p className="outro">Tout cela semble clair pour vous ? Alors lancez-vous et allez ré-écrire l'histoire de votre héros préféré !</p>
          </div>
          <button
